...
/*********************************************************************************/
#define i2c_read_sda()  ((DL_GPIO_readPins(GPIOB,  DL_GPIO_PIN_18))?:1,0)
#define i2c_sda_high()  DL_GPIO_setPins(GPIOB,   DL_GPIO_PIN_18)
#define i2c_sda_low()   DL_GPIO_clearPins(GPIOB, DL_GPIO_PIN_18)
#define i2c_scl_high()  DL_GPIO_setPins(GPIOB,   DL_GPIO_PIN_17)
#define i2c_scl_low()   DL_GPIO_clearPins(GPIOB, DL_GPIO_PIN_17)
...
void i2c_sda_out(void)
{
	...
	DL_GPIO_enableOutput(GPIOB, DL_GPIO_PIN_18);
}
